# RabbitMQ(rpm)安装3.8.x

## 安装说明

> RabbitMQ 采用 Erlang 语言开发，所以在安装 RabbitMQ 前需要安装 Erlang，
> 安装前建议先查看[Erlang官方说明](https://github.com/rabbitmq/erlang-rpm)，
> 注意 Readme 上的版本兼容性问题。
...
![image-20220422152149503](https://yuikuen-1259273046.cos.ap-guangzhou.myqcloud.com/devops/image-20220422152149503.png)
